        ...
        <div className="footer" style={{  backgroundColor:"grey"}}>
            <div className="row">
                ...
                <div className="col-sm">
                    ...
                    <a href="https://www.theroadhome.org/give/in-kind-donations/" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true" style = {{marginTop: "25px", marginLeft:"37%", marginBottom: "15px" , backgroundColor: "#333333"}}>Donate</a>
                </div>
