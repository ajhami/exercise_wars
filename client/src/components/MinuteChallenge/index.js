    ...
    return (
        <div className="card" style={{ height: "450px", backgroundColor: "grey", width: "25%" }}>
            <div className="img">
                ...
                <a href="/SoloChallenge" className="btn btn-primary btn-lg active" role="button" aria-pressed="true" style = {{marginTop: "25px", marginLeft: "23%", backgroundColor:"red"}}>Minute Challenge</a>
            </div>
        </div>
    )
}
